...
export default function furitsVegetables() {
    return (
        <div className='pt-[1.5vw] pb-[10vw] w-[70%] flex flex-wrap gap-[1vw] pl-[2vw] pr-[10vw]'>
            <div className='h-[22vw] w-[13.5vw] border-[#f3f4f8] border-[0.2vw] p-[0.5vw] flex flex-col relative'>
                <img className='w-[10vw] self-center' src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-56-346x310.jpg" alt="Fresh Brown Coconut"></img>
                <div className='flex flex-col gap-3'>
                    <p className='text-[1vw] '>Fresh Brown Coconut</p>
