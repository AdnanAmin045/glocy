...
export default function beverages() {
  return (
    ...
    <div className='h-[22vw] w-[13.5vw] border-[#f3f4f8] border-[0.2vw] p-[0.5vw] flex flex-col relative'>
        <img className='w-[10vw] self-center' src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-346x310.jpg" alt="Zevia Kidz Strawberry Lemonade"></img>
        <div className='flex flex-col gap-3'>
            <p className='text-[1vw] '>Zevia Kidz Strawberry Lemonade</p>
